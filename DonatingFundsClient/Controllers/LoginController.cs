    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(User user)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var response = await httpClient.PostAsync("https://localhost:44315/api/auth/User", content);
                ...
                using (var response1 = await httpClient.PostAsync("https://localhost:44315/api/auth/Login", content1))
                {
